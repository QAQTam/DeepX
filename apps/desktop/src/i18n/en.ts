const en = {
  ...
  settings: {
    ...
    multimodal: {
      ...
      provider: "Provider",
      apiKey: "API Key",
      apiKeyHint: "Leave empty to use the main API Key",
      apiKeyPlaceholder: "Enter multimodal API Key",
      apiKeyConfigured: "Configured",
      baseUrl: "Base URL",
      baseUrlPlaceholder: "Leave empty to use Provider default",
      model: "Model",
      maxTokens: "Max Tokens",
    },
  },
  ...
  environment: {
    ...
    modelUnknown: "Model not connected",
    context: "Context",
