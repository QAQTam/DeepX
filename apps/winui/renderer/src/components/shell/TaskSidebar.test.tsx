...
const session = (seed: string, summary = ""): SessionMeta => ({ seed, last_summary: summary, created_at: 0n, updated_at: 0n, model: "", message_count: 0, turn_count: 0, compact_skip: 0, mode: 0, skills: { version: 2, context_epoch: 0n, operation_revision: 0n, entries: [] }, running: false });
