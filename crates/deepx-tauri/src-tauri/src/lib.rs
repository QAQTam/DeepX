...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            agent_bridge::cmd_set_database_enabled,
            agent_bridge::cmd_load_config,
            agent_bridge::cmd_set_permission_level,
            agent_bridge::cmd_list_sessions,
            agent_bridge::cmd_list_session_activity,
            agent_bridge::cmd_audit_turso_mirrors,
            agent_bridge::cmd_reconcile_turso_mirrors,
            agent_bridge::cmd_check_db_primary_readiness,
